      ...
      */
      setMatching([
        ...
        },
        {
          ...
          available_hours: ["Tue-Sun 10:00-18:00"],
          avatar_url: "https://randomuser.me/api/portraits/men/32.jpg",
          clients: ["73f87af2-543b-4226-8241-b560a33d1723"],
        },
        {
          id: "a7f8c2b1-1234-4cde-9a87-1a2b3c4d5e6f",
          name: "Lina Moretti",
          ...
          specialties: ["Strength Training", "Functional Fitness", "Mobility"],
          certifications: ["NASM CPT", "CrossFit Level 1"],
          available_hours: ["Mon-Fri 8:00–16:00"],
          avatar_url: "https://randomuser.me/api/portraits/women/44.jpg",
          clients: ["73f87af2-543b-4226-8241-b560a33d1723"],
        },
        {
          ...
          rating: 4.9,
          experience_years: 5,
          bio: "Certified personal trainer specializing in yoga and functional training",
          specialties: ["Yoga", "Functional Training"],
        ...
        },
        {
          ...
          rating: 4.7,
          experience_years: 7,
          bio: "Strength training and bodybuilding expert",
          specialties: ["Strength Training", "Bodybuilding"],
          certifications: ["ACE Personal Trainer"],
          available_hours: ["Mon-Fri 9:00–17:00"],
        ...
        {
          id: "c1a1b2c3-d4e5-4623-a1b2-3c4d5e6f7a8b",
          name: "Bob Smith",
          role: "Trainer",
          rating: 4.5,
          experience_years: 3,
          bio: "Entry-level fitness trainer",
          specialties: ["Cardio", "Functional Fitness"],
          certifications: ["ACE Personal Trainer"],
          available_hours: ["Mon-Fri 9:00–17:00"],
        ...
        {
          id: "f4e5d6c7-b8a9-4123-8765-1a2b3c4d5e6f",
          name: "Carol Davis",
          role: "Trainer",
          rating: 4.9,
          experience_years: 7,
          bio: "Functional training and endurance specialist",
          specialties: ["Functional Training", "Endurance"],
          certifications: ["NASM CPT"],
          available_hours: ["Tue-Fri 7:00–15:00"],
        ...
        },
        {
          ...
          experience_years: 8,
          bio: "Best trainer",
          specialties: ["Weight Lifting", "Cardio"],
          certifications: ["NASM CPT"],
          available_hours: ["Mon-Fri 07:00–15:00", "Tue-Tue 13:00–07:00"],
